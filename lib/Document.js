...
Document.prototype = utils.Object.create('Document#', ContainerNode.prototype, {
  ...
  nodeName: { value: '#document', writable: isApiWritable, },
  nodeValue: {
    get: function() {
      return null;
    },
  ...
  origin: { get: function origin() { return null; }, configurable: isApiWritable },
  characterSet: { get: function characterSet() { return "UTF-8"; }, configurable: isApiWritable },
  contentType: { get: function contentType() { return this._contentType; }, configurable: isApiWritable },
  URL: { get: function URL() { return this._address; }, configurable: isApiWritable },
  domain: { get: utils.nyi, set: utils.nyi, configurable: isApiWritable },
  referrer: { get: utils.nyi, configurable: isApiWritable },
  cookie: { get: utils.nyi, set: utils.nyi, configurable: isApiWritable },
  lastModified: { get: utils.nyi, configurable: isApiWritable },
  location: {
	get: function() {
  ...
  charset: { get: function() { return this.characterSet; }, configurable: isApiWritable },
  inputEncoding: { get: function() { return this.characterSet; }, configurable: isApiWritable },
  ...
  body: {
    ...
    set: utils.nyi, configurable: isApiWritable
  },
  // Return the first <head> child of the document element.
  head: { get: function() {
    return namedHTMLChild(this.documentElement, 'head');
  }, configurable: isApiWritable },
  images: { get: utils.nyi, configurable: isApiWritable },
  embeds: { get: utils.nyi, configurable: isApiWritable },
  plugins: { get: utils.nyi, configurable: isApiWritable },
  links: { get: utils.nyi, configurable: isApiWritable },
  forms: { get: utils.nyi, configurable: isApiWritable },
  scripts: { get: utils.nyi, configurable: isApiWritable },
  applets: { get: function() { return []; }, configurable: isApiWritable },
  activeElement: { get: function() { return null; }, configurable: isApiWritable },
  innerHTML: {
...
eventHandlerTypes.forEach(function(type) {
  ...
  utils.Object.defineProperty('Document#', Document.prototype, 'on' + type, {
    get: function() {
